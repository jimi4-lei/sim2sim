...
1000022765.jpg
1000022767.jpg
就是相当于用我前面两个从其他地方截的课程代替到后面这张图的橙色框和蓝色框缺课的地方，每一个课程都要对齐，贴补完之后要把橙色框和蓝色框都去掉，字体要一样，结果就是我这个课表上面的那两个地方显示有课的
...
--------------------------------------------------------------------------------
                         Iteration time: 36.07s
                           Time elapsed: 2:36:35
                                    ...
                                    ETA: 1 day, 3:51:20
                                               ETA: 1 day, 3:51:20
            这是我在用isaaclab的rsl rl框架训练四足机器人模型时的终端展示，从最开始的负33到现在奖励值负了这么多，这正常吗，这种情况一般是什么原因导致的啊
